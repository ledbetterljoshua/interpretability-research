...
def evaluation(out,label,rows,choice_ids,phase,filename=None):
    ...
    assert value["label"]==label and value["n"]==value["forward_examples"]==32
    assert value["forward_batches"]==8 and value["batch_size"]==4 and value["sequence_length"]==512
    assert value["padded_input_tokens"]==32*512 and value["input_tokens"]==phase["attempted_input_tokens"]
