...
training item in each answer class A..D. The transferred lock's own code,
`marble-compass-482`, is absent from this search. The known source code is
deliberately included, including when evaluating source models. Save all
